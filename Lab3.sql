...
#Challenge
DELIMITER $$
CREATE DEFINER=`rhd11`@`%` PROCEDURE `getMovies`(IN releaseYear int)
BEGIN
...
#Challenge
DELIMITER $$
CREATE DEFINER=`rhd11`@`%` PROCEDURE `getMovie`(IN lastName varchar(45), IN firstName varchar(45))
BEGIN
...
#Challenge
DELIMITER $$
CREATE DEFINER=`rhd11`@`%` PROCEDURE `getActors`()
BEGIN
